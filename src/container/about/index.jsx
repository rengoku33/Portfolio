    ...
    return (
        <section className="about">
            ...
            <p style={{fontSize:'2.1rem'}}>
                ...
                school to work environment. Honestly, I mastered the programming languages, frameworks, work flows, SDLCs we followed in under 3 months. It was a double 
                ...
                was completely monotonous, and at that point of time, I was ignorant of the glorious software engineering world and was stuck as a frameworker rather than a engineer. 
            ...
            <p style={{fontSize:'2.1rem'}}>
                ...
                was not good, but my team was supportive and the work load was really low. Now I had enormous amount of time to explore new frameworks, concepts, langugaes. I found the motivation and passion
            ...
            <p style={{fontSize:'2.1rem'}}>
                ...
                the pay is not good and my comapany has fewer clients and none of them were big shots, once a product is pushed to production then there is not much to do with support.
            </p><br />
            <p style={{fontSize:'2.1rem'}}>
                In conclusion - I genuinely enojy building projects and working on challenging environments, I wish to keep learning new tech rather than being stuck 
                with a particular tech stack or framework. My personal objective is to become a software engineer at FAANGM and work on revolutionary products that has a significant 
                impact in people's daily lives. well... Thats pretty much it, this is my life so far and I absolutely love it. If you find this blog or any of my projects interesting, 
